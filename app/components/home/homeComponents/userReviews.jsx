...
export default class UserReviews extends Component {
  render(){
    ...
    return (
      <div>
       <Grid>
         <Row className="show-grid table table-bordered">
           ...
           <Col className='centered' xs={6} md={4}><code><h4 className='black'>{'kelly'}</h4><img src={img3} height={130} width={125}/><h4 className='blue'>{revw3}</h4></code></Col>
         </Row>
        </Grid>
      </div>
    )
